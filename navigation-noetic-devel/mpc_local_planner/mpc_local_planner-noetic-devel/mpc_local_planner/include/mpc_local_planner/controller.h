 ...
 *  1. about line 142 change class Controller members [_force_reinit_new_goal_dist & _force_reinit_new_goal_angle] into [_force_reinit_new_goal_dist_x & _force_reinit_new_goal_dist_y] 
 *********************************************************************/
...
class Controller : public corbo::PredictiveController
{
 ...
 protected:
   ...
   //  double _force_reinit_new_goal_angular = 0.5 * M_PI;
    double _force_reinit_new_goal_dist_x    = 1.0;
    double _force_reinit_new_goal_dist_y    = 1.0;
